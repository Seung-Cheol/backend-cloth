...
public class OrderController {
  ...
  public CommonResponseDto<String> addOrder() {
    return CommonResponseDto.ofSuccess("성공", "주문 추가 성공");
  }

  @GetMapping("/list")
  public CommonResponseDto<String> getOrderList() {
    return CommonResponseDto.ofSuccess("성공", "주문 조회 성공");
  }

  @PutMapping("cancel")
  public CommonResponseDto<String> cancelOrder() {
    return CommonResponseDto.ofSuccess("성공", "주문 취소 성공");
  }

  @PutMapping("refund")
  public CommonResponseDto<String> refundOrder() {
    return CommonResponseDto.ofSuccess("성공", "주문 환불 성공");
  }
